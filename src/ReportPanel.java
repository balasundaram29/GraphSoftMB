...
public final class ReportPanel extends JPanel {
    ...
    void go() {
        ...
        setLayout(null);
        setBounds(0, 0, w, h);
        this.setPreferredSize(new Dimension(1024, 640)); //getParent().validate();
        //} catch (Exception ex) {
        //  showErrorMessage();
        //ex.printStackTrace();
        //return;
    ...
    public double[] calculateMultFactors() {
        double[] multFactors = new double[8];
        JTable entryTable = entryPanel.getTable();
        multFactors[0] = 0.0;
        for (int i = 1; i < 8; i++) {
    ...
    public double[][] findReportValues(double[][] given) {
        ...
        // System.out.println("Pipe constant for " + dia + "mm diameter  is" + pipeConstant);
    ...
    public void addTitle() {
        JPanel titlePanel = new JPanel() {
            ...
            public void paintComponent(Graphics g) {
                ...
                g2D.drawString("Test Report of Monoblock Pumpset, IS 9079", 2, 45);
            }
        };
    ...
    public void getAndAddTable(double[][] data) {
        ...
        Object[] columnNames = {"Sl.No", "Freq", "<HTML>Suction Gauge<BR>Reading</HTML> ", "<HTML>Del.Gauge<BR>Reading", "VHC", "<HTML>Total<BR>Head</HTML>",
  ...
  //      reportTable.setBorder(BorderFactory.createLineBorder(Color.black, 1));
        // this.setTableCellBorder(BorderFactory.createLineBorder(Color.black, 1), reportTable);
        //reportTable.getCellRenderer(2, 5).getTableCellRendererComponent(reportTable, data, true, true, w, WIDTH)
        ...
        tScroller.setBounds(5, 270, w - 10, reportTableHeight - 4);//trial and error
        //tScroller.setBorder(BorderFactory.createLineBorder(Color.black, 1));
        add(tScroller);
    ...
    public void generateExcelReport(GraphPanel gp) {
        try {
            ...
            BufferedImage image = new BufferedImage(
                    w - 8, h - 118, BufferedImage.TYPE_INT_RGB);
    ...
    private void addDeclaredValuesPanel() {
        ...
        enteredTypeLabel.setFont(labelFont);
         JLabel ratingLabel = new JLabel("Rating (kW / H.P.) : ");
        ...
        valuesPanel.add(enteredPipeSizeLabel);
