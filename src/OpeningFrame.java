...
public final class OpeningFrame extends JFrame implements DocumentListener, WindowListener {
    ...
    private String baseTitle = " Annai : Graph Software - Centrifugal Monoblock Pumpsets";
...
//        TableCreator.createTablesIfNotExists();
    ...
    public static void main(String[] args) {
        /*
         * try {
         * UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());//(null)"com.sun.java.swing.plaf.motif.MotifLookAndFeel");
         * } catch (Exception ex) { //Just print stacktrace here since it's an
    ...
    class PrintGraphAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            try {
                //entryPanel.setGridLinesType(graphPanel.getGraph().getPlot().getGridLinesType());
                LoessSmoothRenderer lr = (LoessSmoothRenderer) graphPanel.getGraph().getPlot().getRendererByDatasetType(DatasetAndCurveType.DISCHARGE_VS_HEAD);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            try {
                ...
                Connection connect = DriverManager
                        .getConnection("jdbc:mysql://localhost/db_for_bis_mb", "root", "");
    ...
    public void listenForEntries() {
        JTable table = this.entryPanel.table;
